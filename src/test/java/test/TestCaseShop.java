...
public class TestCaseShop {
	...
	@Test
	public void shopNumCheck() throws InterruptedException {

		/** 商城条目数验证 **/

		dr.switchTo().defaultContent();
		System.out.println("开始找主数据4");
		...
		dr.findElement(By.xpath("//a[text()[contains(.,'商城商品查询')]]")).click();
		...
		WebElement pageRight = dr.findElement(By
				.xpath("//div[contains(@class,'mini-pager-right')]"));
		System.out.println("####shop#####"+pageRight.getText()+"#########");
